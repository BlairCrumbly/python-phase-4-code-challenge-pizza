"""added s.rules and realtionships
...
revision = '13b701ce6bf9'
down_revision = 'a7ed4292ef72'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('restaurant_pizzas', schema=None) as batch_op:
        ...
        batch_op.drop_constraint('fk_restaurant_pizzas_resturant_id_restaurants', type_='foreignkey')
...
def downgrade():
    ...
    with op.batch_alter_table('restaurant_pizzas', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('fk_restaurant_pizzas_resturant_id_restaurants', 'restaurants', ['resturant_id'], ['id'])
